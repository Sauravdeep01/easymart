                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 pt-8">
                    {shopCategories.map((category, index) => (
                        <Link
                            ...
                            key={index}
                            className="relative h-48 group overflow-hidden rounded-xl cursor-pointer shadow-lg transform transition-all duration-500 hover:scale-105 hover:-translate-y-2 hover:shadow-2xl"
                        >
                            <img
                                src={category.img}
                                alt={category.title}
